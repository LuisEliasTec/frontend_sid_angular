...
@Component({
  selector: 'app-consulting-rooms-dialog',
  templateUrl: './consulting-rooms-dialog.component.html',
  styleUrls: ['./consulting-rooms-dialog.component.scss']
})
export class ConsultingRoomsDialogComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<ConsultingRoomsDialogComponent>,
